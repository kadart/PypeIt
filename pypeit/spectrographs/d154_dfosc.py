...
#        detector_dict['ronoise'] = np.atleast_1d(head1['RDNOISE'])  # e-
    ...
    def default_pypeit_par(cls):
        ...
        #par['calibrations']['scattlightframe']['process']['use_illumflat'] = False 
        #par['calibrations']['scattlightframe']['process']['use_pixelflat'] = False 
        #par['calibrations']['scattlightframe']['process']['satpix'] =  None
